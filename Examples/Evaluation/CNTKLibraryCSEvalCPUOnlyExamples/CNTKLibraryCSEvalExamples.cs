...
namespace CNTKLibraryCSEvalExamples
{
    public class CNTKLibraryManagedExamples
    {
        ...
        /// <summary>
        /// The example shows
        /// - how to evaluate model using asynchrous task. This is useful when offloading is needed to achieve better responsiveness.
        /// The asynchrous evaluation is implemented as an extension method in CNTKExtensions.cs, which provides an asynchrounous facade for the synchrnous Evaluation().
        /// </summary>
        /// <param name="device">Specify on which device to run the evaluation.</param>
        public static async Task EvaluationSingleImageAsync(DeviceDescriptor device)
        {
            try
            {
                Console.WriteLine("\n===== Evaluate image asynchrounously =====");
